...
const Navbar = () => {
  ...
  return (
    <nav className=" sticky top-0 left-0 w-full z-50 bg-white shadow-lg backdrop-blur-md bg-opacity-90 px-4 py-3 md:px-6 md:py-4 flex justify-between items-center rounded-b-lg">
        ...
        {isMobileMenuOpen && (
          ...
          >
            <ul className="flex flex-col gap-3">
              ...
              {/* "Book a Free Consultation" Button for Mobile */}
