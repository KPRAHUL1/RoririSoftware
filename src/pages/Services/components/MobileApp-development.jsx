                ...
                <div key={index} className="w-full flex-shrink-0">
                  <div className="grid lg:grid-cols-2 gap-16 items-center p-12">
                    ...
                    <div className={`space-y-6 ${slide.type === 'ios' ? 'lg:order-2' : ''}`}>
                      ...
                      <div className="pt-6">
                        <button className="bg-gradient-to-r from-blue-600 to-cyan-600 text-white px-8 py-4 rounded-xl font-semibold text-lg hover:shadow-lg hover:shadow-blue-500/25 transition-all duration-300 transform hover:scale-105">
                          Learn More
                        </button>
                      </div>
                    </div>
